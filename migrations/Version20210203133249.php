 ...
 */
final class Version20210203133249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD valid TINYINT(1) NOT NULL, DROP category_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, DROP valid');
